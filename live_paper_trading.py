#this is backtest+live testing paper trading bot based on ema
...
comapny = "LALPATHLAB.NS" #company selction
...
start="2020-09-22"  #start: str:->Download start date string (YYYY-MM-DD) Default is 1900-01-01
